...
Gem::Specification.new do |spec|
  spec.name = RspecMatchersAdhereToSchema::Identity.name
  spec.version = RspecMatchersAdhereToSchema::Identity.version
  spec.platform = Gem::Platform::RUBY
  spec.authors = ["Pooyan Khosravi"]
  spec.email = ["pekhee@gmail.com"]
  spec.homepage = "https://github.com//rspec_matchers_adhere_to_schema"
